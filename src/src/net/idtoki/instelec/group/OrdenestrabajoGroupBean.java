 ...
 */
public class OrdenestrabajoGroupBean
    extends net.idtoki.instelec.group.BaseOrdenestrabajoGroupBean
{
  public OrdenestrabajoGroupBean(){
        this.dbField = OrdenestrabajoPeer.IDORDEN;
